...
class Server {
    ...
    constructor() {
         ...
         *  vhost: Map<String, {
         *    lock: {
         *      byKey: Map<Number, Boolean>,
         *      bySocket: Map<Number, Map<Number, Boolean>>,
         *    }
         *  }>
         * }}
         */
    ...
    initNet() {
        ...
        this.net.on('connection', (sourceSocket) => {
            let id = this.id++;
            ...
            socket.setId(id);
            socket.setSocket(sourceSocket);
            this.index.socket.byId.set(id, socket);
        })
    }
